...
import { Shield, Key, Lock, Activity, ArrowRight, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen mesh-gradient flex items-center justify-center p-6 relative overflow-hidden">
      {onBack && (
        <button 
          onClick={onBack}
          className="absolute top-8 left-8 flex items-center gap-2 text-blue-200/60 hover:text-white transition-colors font-bold uppercase tracking-widest text-[10px] z-20"
        >
